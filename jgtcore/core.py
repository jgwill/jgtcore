...
def update_settings(old_settings: Dict[str, Any], new_settings: Dict[str, Any], keys: list = ['patterns']) -> None:
...
def load_settings(custom_path: Optional[str] = None, old: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
...
def load_arg_default_from_settings(argname: str, default_value: Any, alias: Optional[str] = None, 
                                  from_jgt_env: bool = False, exclude_env_alias: bool = False) -> Any:
    """
...
def load_arg_default_from_settings_if_exist(argname: str, alias: Optional[str] = None) -> Optional[Any]:
    """
...
def readconfig(json_config_str: Optional[str] = None, config_file: str = 'config.json', 
               export_env: bool = False, config_file_path_env_name: str = 'JGT_CONFIG_PATH', 
               config_values_env_name: str = 'JGT_CONFIG', force_read_json: bool = False, 
               demo: bool = False, use_demo_json_config: bool = False) -> Dict[str, Any]:
    """
    ...
    if demo and use_demo_json_config:
        ...
        if not os.path.exists(config_file):
            print(f"Configuration not found. create : {config_file} or we will try to use the _demo in the usual config.json")
...
def is_market_open(current_time: Optional[datetime] = None, exit_cli_if_closed: bool = False, 
                  market_closed_callback: Optional[callable] = None) -> bool:
    """
...
def get_setting(key: str, default: Any = None, custom_path: Optional[str] = None) -> Any:
    """
...
def setup_environment(demo: bool = False, custom_settings_path: Optional[str] = None) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    """
